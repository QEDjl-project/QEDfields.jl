...
QEDfields.pulse_duration(::TestBGfield) = RND_DOMAIN_WIDTH
...
@testset "hard interface" begin
    ...
    @test pulse_duration(test_field) == RND_DOMAIN_WIDTH
end
...
@testset "failed interface" begin
    ...
    @test_throws MethodError pulse_duration(test_field_FAIL)
end
